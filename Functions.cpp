...
Vector3 ClosestPoint(const Vector3& point, const Segment& segment)
{
	...
	//Vector3 proj = Project(point, segment.diff);
	...
	//result.x  = (1.0f - t)* segment.origin.x + t * segment.diff.x;
	//result.y  = (1.0f - t)* segment.origin.y + t * segment.diff.y;
	//result.z  = (1.0f - t)* segment.origin.z + t * segment.diff.z;

	//result.x = point.x - result.x;
	//result.y = point.x - result.y;
	//result.x = point.z - result.z;
